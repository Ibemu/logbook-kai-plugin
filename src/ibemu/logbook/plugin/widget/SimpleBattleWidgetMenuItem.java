...
public class SimpleBattleWidgetMenuItem implements MainCommandMenu
{
    @Override
    public MenuItem getContent()
    {
        MenuItem content = new MenuItem();
        content.setText("簡易出撃報告");
        content.setOnAction(e ->
        {
            try
            {
                FXMLLoader loader = new FXMLLoader(PluginContainer.getInstance().getClassLoader().getResource("ibemu/logbook/plugin/widget/SimpleBattleWidget.fxml"));
    ...
    private static class LoggerHolder
    {
         ...
         * ロガー
         */
        private static final Logger LOG = LogManager.getLogger(SimpleBattleWidgetMenuItem.class);
    }
}
